...
define("dropdown/dropdown.js", ["hsp/$set","hsp/klass","hsp/rt"], function (module, global){
var require = module.require, exports = module.exports, __filename = module.filename, __dirname = module.dirname;
...
var DropdownHandler = klass({
    $constructor : function (nodeInstance) {
        $set(this, "nodeInstance", nodeInstance);
        $set(this, "node", nodeInstance.node);
    },
    ...
    $dispose : function() {
        ...
        $set(this, "nodeInstance", null);
        $set(this, "node", null);
        $set(this, "toggleHandler", null);
    ...
    _open: function() {
        ...
        $set(this.node, "className", newClassName.join(' '));
    ...
    _attachDocumentListeners: function() {
        $set(this, "documentHandler", this._handleDocumentEvent.bind(this));
        var _this = this;
        setTimeout (function() {
...
var ToggleHandler = klass({
    $constructor : function (nodeInstance) {
        ...
        if (ancestor) {
            $set(this, "dropdown", ancestor.getCustomAttributeHandlers("bootstrap-dropdown")[0]);
