...
var demo =$set(exports, "demo", require("hsp/rt").template({ctl:[alertController,"alertController"],ref:"ctrl"}, function(n){
  var _alert;try {_alert=alert} catch(e) {_alert=n.g('alert')};
  return [n.$text(0,[" "]),n.elt("div",0,{"style":"width:400px"},0,[n.cpt([_alert,"alert"],{e1:[1,2,"ctrl","alertClosed"]},{"type":"success","closebutton":"false","closed":["",1]},0,[n.$text(0,["I am an alert without a close button! "]),n.elt("br",0,0,0),n.elt("a",{e1:[3,2,"ctrl","onclose",1,2],e2:[0,1,"event"]},{"href":"#"},{"click":1},[n.$text(0,["Close Me!"])])]),n.$text(0,[" "]),n.cpt([_alert,"alert"],0,{"type":"info","fade":"false"},0,[n.$text(0,["I am an alert without any closing transition - close me and I just disappear!"])]),n.$text(0,[" "]),n.cpt([_alert,"alert"],{e1:[3,2,"ctrl","onclosestart"],e2:[3,2,"ctrl","oncloseend"]},{"type":"warning"},{"closestart":1,"closeend":2},[n.$text(0,["I am an alert with callbacks for onclosestart and oncloseend - close me and check your console!"])]),n.$text(0,[" "]),n.cpt([_alert,"alert"],0,0,0,[n.$text(0,["I am the default type of alert which is \"danger\", so no attributes needed for me!"])]),n.elt("button",{e1:[3,2,"ctrl","toggle"]},{"type":"button","class":"btn btn-default"},{"click":1},[n.$text(0,["Open and close an alert from a button!"])])])];
}));
